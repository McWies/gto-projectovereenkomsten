...
export default function App() {
  ...
  // Synchroniseer automatisch wanneer een ander tabblad de database wijzigt.
  // Zonder dit overschrijft een oud tabblad de wijzigingen van een nieuw tabblad.
  useEffect(() => {
    function onStorageChange(e) {
      if (e.key === 'gto_db' && e.newValue) {
        try {
